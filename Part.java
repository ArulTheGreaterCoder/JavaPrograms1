...
public class Part{
    public static void main(String[] args){
        Book book = new Book("B001","1994",LocalDate.of(1949,6,8),"George Orwell",328);
        ...
        System.out.println("Alice's checked-out items: "+ alice.getNumItemsCheckedOut());

        alice.returnItem(dvd);
        System.out.println("Alice's items after return: "+ alice.getNumItemsCheckedOut());

        alice.checkOutItem(cd);
        System.out.println("Alice's items after checking out a CD: "+ alice.getNumItemsCheckedOut());
    }
}